...
/**
 * DAO implementation for Faction.
 *
 * @author RAF
 */
@Repository
public final class FactionDaoImpl extends AbstractDao<Faction, Integer> implements FactionDao {
   ...
   */
  @Override
  protected Order getOrder(final CriteriaBuilder builder, final Root<Faction> root) {
